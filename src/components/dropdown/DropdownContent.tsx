  ...
  ({ className, sideOffset = 6, collisionPadding = 8, ...props }, ref) => (
    <DropdownMenu.Portal>
      <DropdownMenu.Content
        ...
        className={cn(
          'dropdown-content z-50 w-[var(--radix-popper-anchor-width)] max-w-[var(--radix-popper-available-width)] rounded-lg border border-border bg-background p-1 shadow-lg will-change-[opacity,transform] focus:outline-none',
